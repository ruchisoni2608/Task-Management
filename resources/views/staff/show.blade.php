        ...
        <div class="row justify-content-center">
            ...
            <table class="table table-bordered table-hover dt-responsive" id="myTable">
                ...
                <tbody id="myTable">
                    ...
                    @if (isset($unreadTasks))
                        @if (count($unreadTasks) <= 1)
                            <tr>

                                <td>{{ $unreadTasks[0]->title }}</td>
                                <td>
                                    <span id="task-status-{{ $unreadTasks[0]->id }}">Pending</span>
                                </td>

                                <td>
                                    <p class="start-time" id="demo1-{{ $unreadTasks[0]->id }}"></p>
                                </td>
                                <td>
                                    <p class="end-time" id="demo2-{{ $unreadTasks[0]->id }}"></p>
                                </td>
                                <td>
                                    <p class="total-time-taken" id="total-time-taken-{{ $unreadTasks[0]->id }}"></p>
                                </td>

                                <td> <button class="start-button btn btn-primary"
                                        data-task-id="{{ $unreadTasks[0]->id }}">Start</button>
                                    <button class="end-button btn btn-danger"
                                        data-task-id="{{ $unreadTasks[0]->id }}">End</button>
                                    <button class="complete-button btn btn-success"
                                        data-task-id="{{ $unreadTasks[0]->id }}">Complete</button>
                            ...
                            @foreach ($unreadTasks as $task)
                                <tr>
                                    ...
                                    <td> <button class="start-button btn btn-primary"
                                        ...
                                        <button class="end-button btn btn-danger"
                                            data-task-id="{{ $task->id }}">End</button>
                                        <button class="complete-button btn btn-success"
                        ...
                        @endif
                    @else
                        <p>No tasks assigned by a manager found.</p>
                    @endif
